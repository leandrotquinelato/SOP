...
{
    public class AutoCompletePessoaJuridicaProvider : IAutoCompleteProvider
    {
        //Propriedades
        ...
        public AutoCompletePessoaJuridicaProvider(string name)
        {
            //Propriedades
            DataTextField = "Text";
            ActionName = "GetPessoaJuridica";
            ControllerName = "PessoaJuridica";
            Name = name;
            MinLength = 3;
            Template = "_autoCompletePessoaJuridicaTemplate.tmpl.htm";

            //Eventos
            //OnChange = "autoCompletePatioFerroviario_change";
            //OnClose = "autoCompletePatioFerroviario_close";
            //OnDataBound = "autoCompletePatioFerroviario_databound";
            //OnOpen = "autoCompletePatioFerroviario_open";
            //OnSelect = "autoCompletePatioFerroviario_select";
            //OnSendData = "autoCompletePatioFerroviario_senddata";
        }
    }
}
