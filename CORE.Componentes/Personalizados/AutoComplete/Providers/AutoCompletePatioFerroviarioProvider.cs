...
{
    public class AutoCompletePatioFerroviarioProvider : IAutoCompleteProvider
    {
        //Propriedades
        ...
        public AutoCompletePatioFerroviarioProvider(string name)
        {
            //Propriedades
            DataTextField = "Text";            
            ActionName = "GetPatios";
            ControllerName = "PatioFerroviario";
            Name = name;
            MinLength = 1;
            Template = "_autoCompletePatioFerroviarioTemplate.tmpl.htm";
