...
{
    public class AutoCompleteTremProvider : IAutoCompleteProvider
    {
        //Propriedades
        ...
        public AutoCompleteTremProvider(string name)
        {
            //Propriedades
            DataTextField = "Prefixo";            
            ActionName = "GetTrens";
            ControllerName = "Trem";
            Name = name;
            MinLength = 3;
            Template = "_autoCompleteTremTemplate.tmpl.htm";

            ////Eventos
            //OnChange = "autoCompleteTrem_change";
            //OnClose = "autoCompleteTrem_close";
            //OnDataBound = "autoCompleteTrem_databound";
            //OnOpen = "autoCompleteTrem_open";
            //OnSelect = "autoCompleteTrem_select";        
        }
    }
}