...
{
    public class AutoCompleteTipoVagaoProvider : IAutoCompleteProvider
    {
        //Propriedades
        ...
        public AutoCompleteTipoVagaoProvider(string name)
        {
            //Propriedades
            DataTextField = "Text";
            ActionName = "TipoVagao";
            ControllerName = "ProducaoTransporte";
            Name = name;
            MinLength = 1;
            Template = "_autoCompleteTipoVagaoTemplate.tmpl.htm";         
