...
{
    public class AutoCompleteMercadoriaProvider : IAutoCompleteProvider
    {
        //Propriedades
        ...
        public AutoCompleteMercadoriaProvider(string name)
        {
            //Propriedades
            DataTextField = "Text";
            ActionName = "Mercadoria";
            ControllerName = "ProducaoTransporte";
            Name = name;
            MinLength = 3;
            Template = "_autoCompleteMercadoriaTemplate.tmpl.htm";         

            //Eventos
            //OnChange = "autoCompleteFluxoTrpt_change";
            //OnClose = "autoCompleteFluxoTrpt_close";
            //OnDataBound = "autoCompleteFluxoTrpt_databound";
            //OnOpen = "autoCompleteFluxoTrpt_open";
            //OnSelect = "autoCompleteFluxoTrpt_select";  
            //OnSendData = "autoCompleteFluxoTrpt_senddata";
        }
