...
{
    public class AutoCompleteVeiculoFerroviarioProvider : IAutoCompleteProvider
    {
        //Propriedades
        ...
        public AutoCompleteVeiculoFerroviarioProvider(string name)
        {
            //Propriedades
            DataTextField = "Text";            
            ActionName = "GetVeiculos";
            ControllerName = "VeiculoFerroviario";
            Name = name;
            MinLength = 3;
            Template = "_autoCompleteVeiculoFerroviarioTemplate.tmpl.htm";            
