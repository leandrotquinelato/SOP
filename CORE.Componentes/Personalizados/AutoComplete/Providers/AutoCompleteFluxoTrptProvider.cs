...
{
    public class AutoCompleteFluxoTrptProvider : IAutoCompleteProvider
    {
        //Propriedades
        ...
        public AutoCompleteFluxoTrptProvider(string name)
        {
            //Propriedades
            DataTextField = "Text";
            ActionName = "Fluxo";
            ...
            Name = name;
            MinLength = 3;
            Template = "_autoCompleteFluxoTrptTemplate.tmpl.htm";         
